package com.green.gallery_jwt_jpa.greengram.config.util;


import com.green.gallery_jwt_jpa.greengram.config.constants.ConstFile;
...
public class ImgUploadManager {
    ...
    public List<String> saveFeedPics(Long feedId, List<MultipartFile> pics) {
        ...
        for (MultipartFile pic : pics) {
            String randomFileName = myFileUtils.makeRandomFileName(pic); //랜덤 파일 이름 생성
